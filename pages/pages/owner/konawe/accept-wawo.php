<?php 
    ...
    $sql = "UPDATE transaksi_wawo SET status = 'On Progress', ket = 'Sudah Cair' WHERE id = $id";
    // if($saldo == 0){
    ...
    $sql = "INSERT INTO tagih_wawo(tgl_cair, tgl_bayar, code, nama_anggota, besar_pinjaman, agunan, besar_angsuran, saldo_awal, saldo_akhir, denda_keterlambatan, ket)
