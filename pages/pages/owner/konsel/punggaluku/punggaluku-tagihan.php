...
<head>
  ...
  <title>Data Tagihan Punggaluku</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="Punggaluku-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="punggaluku-pengajuan.php">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="punggaluku-tagihan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
