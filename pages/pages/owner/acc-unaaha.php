...
<head>
  ...
  <title>Persetujuan Pengajuan Unaaha</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="acc-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="acc-unaaha.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Persetujuan Pengajuan Unaaha</h1>
      <nav>
        <ol class="breadcrumb">
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables display nowrap" width="100%">
                ...
                foreach ($data as $db){
                  ...
                  $path_kartu = "../admin/konawe/unaaha/img/jaminan/".$foto_kartu;
                  $path_nasabah = "../admin/konawe/unaaha/img/nasabah/".$foto_nasabah;
                  $acc = $db["persetujuan"];
                  ...
                  echo "<th scope='row'>$id</th>";
                    ...
                    echo "<td>";
                         echo "<a href='konawe/accept-una.php?id=$id'><span class='badge bg-success'><i class='bi bi-check-circle me-1'></i> Terima</span></a>";
                    echo "</td>";
                    echo "<td>
                          <a href='konawe/reject-una.php?id=$id'><span class='badge bg-danger'><i class='bi bi-check-circle me-1'></i> Tolak</span></a>
                          </td>";
                  echo "</tr>";
                 }
