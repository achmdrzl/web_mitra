...
<head>
  ...
  <title>Data Tagihan Keraton</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="Keraton-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="keraton-pengajuan.php">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="keraton-tagihan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
