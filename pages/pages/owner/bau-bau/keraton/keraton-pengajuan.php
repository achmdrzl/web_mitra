...
<head>
  ...
  <title>Data Pengajuan Keraton</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#Keraton-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Keraton</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="Keraton-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="keraton-pengajuan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="keraton-tagihan.php">
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables" width="100%">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM transaksi_bau WHERE status = 'On Progress' OR status = 'Lunas' OR status = 'Di Tolak' ";
                  ...
                  foreach($data as $db) {
                    ...
                    $path_kartu = "../../../admin/bau-bau/keraton/img/jaminan/".$foto_jaminan;
