...
<head>
  ...
  <title>Persetujuan Pengajuan Wua-Wua</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="acc-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="acc-wua.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Persetujuan Pengajuan Wua-Wua</h1>
      <nav>
        <ol class="breadcrumb">
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables display nowrap" width="100%">
                ...
                foreach ($data as $db){
                  ...
                  $path_kartu = "../admin/kendari/wua-wua/img/jaminan/".$foto_kartu;
                  $path_nasabah = "../admin/kendari/wua-wua/img/nasabah/".$foto_nasabah;
                  $acc = $db["persetujuan"];
                  ...
                  echo "<th scope='row'>$id</th>";
                    ...
                    echo "<td>";
                         echo "<a href='kendari/accept-wua.php?id=$id'><span class='badge bg-success'><i class='bi bi-check-circle me-1'></i> Terima</span></a>";
                    echo "</td>";
                    echo "<td>
                          <a href='kendari/reject-wua.php?id=$id'><span class='badge bg-danger'><i class='bi bi-check-circle me-1'></i> Tolak</span></a>
                          </td>";
                  echo "</tr>";
                 }
