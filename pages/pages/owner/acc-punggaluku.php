...
<head>
  ...
  <title>Persetujuan Pengajuan Punggaluku</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#acc-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Persetujuan Pengajuan</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="acc-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="acc-kdi.php"  >
          ...
          <li>
            <a href="acc-punggaluku.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Persetujuan Pengajuan Punggaluku</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Persetujuan Pengajuan</li>
      ...
      <div class="row">
        <div class="col-lg-12 ">
          ...
          <div class="card mt-lg-auto">
            <div class="card-body">
              <h5 class="card-title">Data Pengajuan Pinjaman</h5>
              
              <!-- Table with stripped rows -->
              <table id="table" class="table table-striped table-bordered datatables display nowrap" width="100%">
                <thead>
                <tr>
                    <th scope="col">No.</th>
                ...
                foreach ($data as $db){
                  ...
                  $path_kartu = "../admin/konsel/punggaluku/img/jaminan/".$foto_kartu;
                  $path_nasabah = "../admin/konsel/punggaluku/img/nasabah/".$foto_nasabah;
                  $acc = $db["persetujuan"];
                  ...
                  echo "<th scope='row'>$id</th>";
                    ...
                    echo "<td>";
                         echo "<a href='konsel/accept-pun.php?id=$id'><span class='badge bg-success'><i class='bi bi-check-circle me-1'></i> Terima</span></a>";
                    echo "</td>";
                    echo "<td>
                          <a href='konsel/reject-pun.php?id=$id'><span class='badge bg-danger'><i class='bi bi-check-circle me-1'></i> Tolak</span></a>
                          </td>";
                  echo "</tr>";
                 }
