...
<head>
  ...
  <title>Data Pengajuan Wua-Wua</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#wua-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Wua-Wua</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="wua-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="wua-pengajuan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="wua-tagihan.php">
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables" width="100%">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM transaksi_wua WHERE status = 'On Progress' OR status = 'Lunas' OR status = 'Di Tolak' ";
                  ...
                  foreach($data as $db) {
                    ...
                    $path_kartu = "../../../admin/kendari/wua-wua/img/jaminan/".$foto_jaminan;
