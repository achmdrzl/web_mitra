...
<head>
  ...
  <title>Form Tagihan Konda</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tagih-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="tagih-konda.php" class="active">
              <i class="bi bi-circle"></i><span>Konda</span>
            </a>
          </li>
          <li>
    ...
    <section class="section">
      ...
      <?php 
          ...
          if(isset($_POST["submit"]) ){
            ...
            $sql = "SELECT * FROM tagih_kon WHERE code = '$code' AND nama_anggota = '$nama_anggota' ";
            ...
            if($s_akhir == 0){
              $sql = "UPDATE transaksi_kon SET status = 'Lunas' WHERE code = '$code' AND nama_anggota = '$nama_anggota'";
            ...
            $sql = "UPDATE tagih_kon SET tgl_bayar = '$tgl_bayar', besar_angsuran = '$besar_angsuran', saldo_awal = '$s_awal', saldo_akhir = '$s_akhir', denda_keterlambatan = '$dk', ket = '$method'
