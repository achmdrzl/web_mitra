...
<head>
  ...
  <title>Form Pengajuan Laeya</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="pengajuan-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="form-laeya.php" class="active">
          ...
          <div class="card">
            ...
            <?php 
              ...
              if(isset($_POST["submit"]) ){
                ...
                $dir1 = 'laeya/img/jaminan/'.$jaminan;
                ...
                $sql = "INSERT INTO transaksi_lae(tgl, code, resort, nama_pdl, nama_anggota, alamat, agunan, pinjam_baru, pinjam_lama, foto_jaminan, foto_nasabah, persetujuan, status, ket) VALUES 
