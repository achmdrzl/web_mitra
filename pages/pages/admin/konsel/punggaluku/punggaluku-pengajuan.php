...
<head>
  ...
  <title>Data Pengajuan Punggaluku</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="../../index-konsel.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Konsel - Laeya</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#Punggaluku-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Punggaluku</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="Punggaluku-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="punggaluku-pengajuan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="punggaluku-tagihan.php">
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Data Pengajuan Punggaluku</h1>
      <nav>
        <ol class="breadcrumb">
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables" width="100%">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM transaksi_pun WHERE status = 'On Progress' OR status = 'Lunas' OR status = 'Di Tolak' ";
                  ...
                  foreach($data as $db) {
                    ...
                    $path_kartu = "../../../admin/konsel/punggaluku/img/jaminan/".$foto_jaminan;
