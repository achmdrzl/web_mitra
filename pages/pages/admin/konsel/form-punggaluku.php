...
<head>
  ...
  <title>Form Pengajuan Punggaluku</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="pengajuan-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="form-punggaluku.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Form Pengajuan Punggaluku</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <div class="card">
            ...
            <?php 
              ...
              if(isset($_POST["submit"]) ){
                ...
                $dir1 = 'punggaluku/img/jaminan/'.$jaminan;
                ...
                $dir = 'punggaluku/img/nasabah/'.$nasabah;
                ...
                $sql = "INSERT INTO transaksi_pun(tgl, code, resort, nama_pdl, nama_anggota, alamat, agunan, pinjam_baru, pinjam_lama, foto_jaminan, foto_nasabah, persetujuan, status, ket) VALUES 
