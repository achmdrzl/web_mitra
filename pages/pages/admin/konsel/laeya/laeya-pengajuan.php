...
<head>
  ...
  <title>Data Pengajuan Laeya</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="Laeya-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="laeya-pengajuan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="laeya-tagihan.php" >
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables" width="100%">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM transaksi_lae WHERE status = 'On Progress' OR status = 'Lunas' OR status = 'Di Tolak' ";
                  ...
                  foreach($data as $db) {
                    ...
                    $path_kartu = "../../../admin/konsel/laeya/img/jaminan/".$foto_jaminan;
