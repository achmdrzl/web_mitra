...
<head>
  ...
  <title>Data Pengajuan Konda</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="Konda-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="konda-pengajuan.php" class="active">
            ...
            <div class="card-body">
              ...
              <table id="table" class="table table-striped table-bordered datatables" width="100%">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM transaksi_kon WHERE status = 'On Progress' OR status = 'Lunas' OR status = 'Di Tolak' ";
                  ...
                  foreach($data as $db) {
                    ...
                    $path_kartu = "../../../admin/konsel/konda/img/jaminan/".$foto_jaminan;
