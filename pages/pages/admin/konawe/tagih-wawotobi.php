...
<head>
  ...
  <title>Form Pengajuan Wawotobi</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tagihan-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tagih-wawotobi.php" class="active">
              <i class="bi bi-circle"></i><span>Wawotobi</span>
            </a>
          </li>
        </ul>
    ...
    <section class="section">
      ...
      <?php 
          ...
          if(isset($_POST["submit"]) ){
            ...
            $sql = "SELECT * FROM tagih_wawo WHERE code = '$code' AND nama_anggota = '$nama_anggota' ";
            ...
            if($s_akhir == 0){
              $sql = "UPDATE transaksi_wawo SET status = 'Lunas' WHERE code = '$code' AND nama_anggota = '$nama_anggota'";
            ...
            $sql = "UPDATE tagih_wawo SET tgl_bayar = '$tgl_bayar', besar_angsuran = '$besar_angsuran', saldo_awal = '$s_awal', saldo_akhir = '$s_akhir', denda_keterlambatan = '$dk', ket = '$method'
