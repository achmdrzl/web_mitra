    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="wua-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="wua-pengajuan.php">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="wua-tagihan.php" class="active">
              <i class="bi bi-circle"></i><span>Data Tagihan</span>
            </a>
          </li>
        </ul>
                  ...
                  foreach($data as $db){
                    ...
                    echo "<th scope='row'>$id</th>";
                      ...
                      if($ket == 'Tunai'){
                        ...
                        echo "<td>";
                        echo "<span class='badge bg-warning text-dark'>$ket</span>";
                        echo "</td>";
                      }
                    echo "</tr>";
                  }
