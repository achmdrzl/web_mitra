...
<head>
  ...
  <title>Data Tagihan Kota Kendari</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="Kendari-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="kdi-pengajuan.php">
              <i class="bi bi-circle"></i><span>Data Pengajuan</span>
            </a>
          </li>
          <li>
            <a href="kdi-tagihan.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Data Tagihan Kota Kendari</h1>
      <nav>
        <ol class="breadcrumb">
