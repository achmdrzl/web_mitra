...
<head>
  ...
  <title>Form Pengajuan Kota Kendari</title>
...
<!--  -->
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tagihan-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="tagih-kdi.php" class="active">
              <i class="bi bi-circle"></i><span>Kendari</span>
            </a>
          </li>
          <li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Form Tagihan Kota Kendari</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      ...
      <?php 
          ...
          if(isset($_POST["submit"]) ){
            ...
            $sql = "SELECT * FROM tagih_kdi WHERE code = '$code' AND nama_anggota = '$nama_anggota' ";
            ...
            if($s_akhir == 0){
              $sql = "UPDATE transaksi_kdi SET status = 'Lunas' WHERE code = '$code' AND nama_anggota = '$nama_anggota'";
            ...
            $sql = "UPDATE tagih_kdi SET tgl_bayar = '$tgl_bayar', besar_angsuran = '$besar_angsuran', saldo_awal = '$s_awal', saldo_akhir = '$s_akhir', denda_keterlambatan = '$dk', ket = '$method'
