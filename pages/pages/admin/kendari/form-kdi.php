...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="pengajuan-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="form-kdi.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Form Pengajuan Kota Kendari</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <div class="card">
            ...
            <?php 
              ...
              if(isset($_POST["submit"]) ){
                ...
                $dir1 = 'kendari/img/jaminan/'.$jaminan;
                ...
                $dir = 'kendari/img/nasabah/'.$nasabah;
                ...
                $sql = "INSERT INTO transaksi_kdi(tgl, code, resort, nama_pdl, nama_anggota, alamat, agunan, pinjam_baru, pinjam_lama, foto_jaminan, foto_nasabah, persetujuan, status, ket) VALUES 
