<?php
  ...
  include '../../../koneksi.php';
	...
	if(!isset($_SESSION['adminkeraton'])){
		$elapsed_time = time()-$_SESSION['adminkeraton'];
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="index-bau.php">
      ...
      <li class="nav-item">
        ...
        <ul id="pengajuan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="bau-bau/form-keraton.php">
      ...
      <li class="nav-item">
        ...
        <ul id="tagihan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="bau-bau/tagih-keraton.php" >
              <i class="bi bi-circle"></i><span>Keraton</span>
            </a>
          </li>
        </ul>
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                <div class="card-body">
                  <h5 class="card-title">Jumlah Pengajuan Lunas <span>| Bau-Bau</span></h5>
          ...
          <!-- Pengajuan On Progress -->
            <div class="col-xxl-4 col-md-4">
              ...
              <div class="card-body">
                  <h5 class="card-title">Pengajuan On Progress <span>| Bau-Bau</span></h5>
            ...
            <div class="col-xxl-4 col-md-4">
              ...
              <div class="card-body">
                  <h5 class="card-title">Total Pengajuan <span>| Bau-Bau</span></h5>
