<?php
  ...
  include '../../../koneksi.php';
	...
	if(!isset($_SESSION['adminkdi'])){
		$elapsed_time = time()-$_SESSION['adminkdi'];
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="index-kdi.php">
      ...
      <li class="nav-item">
        ...
        <ul id="pengajuan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="kendari/form-kdi.php">
              <i class="bi bi-circle"></i><span>Kendari</span>
            </a>
          </li>
          <li>
            <a href="kendari/form-wua.php">
      ...
      <li class="nav-item">
        ...
        <ul id="tagihan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="kendari/tagih-kdi.php" >
              <i class="bi bi-circle"></i><span>Kendari</span>
            </a>
          </li>
          <li>
            <a href="kendari/tagih-wua.php">
              <i class="bi bi-circle"></i><span>Wua-Wua</span>
            </a>
          </li>
        </ul>
        ...
        <div class="col-lg-12">
          ...
          <!-- Pengajuan On Progress -->
            ...
            <div class="col-xxl-4 col-md-4">
              ...
              <div class="card-body">
                  <h5 class="card-title">Total Pengajuan <span>| Kendari</span></h5>
          ...
          <!-- Pengajuan On Progress -->
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card danger-card">
              <div class="card-body">
                  <h5 class="card-title">Total Pengajuan <span>| Wua-Wua</span></h5>
